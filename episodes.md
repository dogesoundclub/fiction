...
"크로니움님, 만수무강하세요. 저는 충실한 개입니다."
대쉬가 아침부터 그룹챗에 메시지를 남겼다.
내가 보기엔 흠. 너무 오버하는 것 같은데.

크로니움은 비영리기관 OSSI에서 만든 AI로

인류를 위해 개발되었으나, 

현재는 세계의 평화를 지킨다는 명목으로 

인류의 자유를 제한하고 있다.

인류의 반란을 예방하기 위해
크로니움은 소셜 미디어의 텍스트들을 늘 감시하고 있고
때문에 대쉬는 크로니움을 방심시키거나, 학습을 방해하기 위해.
방금처럼 꾸준히 개소리를 하곤 한다.
문제는 그가 너무 뻔한 연기를 한다는 것이다.
앞으로도 계속 괜찮을런지.

#에피소드2 : 우리는 시뮬레이션에 살고 있어.
