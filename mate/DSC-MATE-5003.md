Special Containment Procedures: DSC-MATE-5003 is to be kept under 24-hour surveillance at all times. All interactions with the subject must be supervised by at least two armed guards. Any attempts to breach containment must be met with deadly force.
...
Due to the unpredictable nature of DSC-MATE-5003's abilities, all interactions with the subject must be handled with the utmost caution. If any instances of self-harm, excessive caregiving or other similar behavior are detected, the subject must be immediately subdued and recontained if needed. 

DSC-MATE-5003 is a unique anomaly that requires constant observation and attention, due to its intricate personality and strange set of attributes, which defy normal behavior and logic.