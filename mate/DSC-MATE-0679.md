...
Special Containment Procedures: DSC-MATE-679 is to be contained within a standard humanoid containment chamber within Site-19. The containment chamber must be equipped with at least two armed guards at all times. In addition, DSC-MATE-679 is to be provided with a studio space that mirrors a fashion studio with an allowance of fabrics, design permits, and tools required to create fashion.
...
DSC-MATE-679 was discovered in New York City in 20██, after several anomalous events, which included clothing design and fabric materialization in areas where DSC-MATE-679 had been last observed. DSC-MATE-679 was contained without incident and has since cooperated with Foundation staff.

Addendum: DSC-MATE-679 occasionally displays a particular interest in creating clothing for Foundation staff. DSC-MATE-679 has been noted to be attempting to document the appearance of various DSCs in an effort to create clothing designs based on the DSC appearances. The request has been denied.