...
## OFFICIAL SETTINGS
- 픽션 DSC는 현대를 배경으로한 도시 판타지입니다.

- 우리가 현실로 알고 지냈던 세계는 알고 보니, 하나의 컴퓨터 시뮬레이션이었습니다.

- 인류는 AI에게 위협을 받고 있습니다.

- 도지사운드클럽 메이트들이 개소리를 하는 주된 이유는 인류의 위협이 되는 AI의 학습을 방해하기 위해서 입니다. 또 개소리는 종종 시뮬레이션에 버그를 일으키는데, 이를 이용하여 다른 시뮬레이션, 세계로 차원 이동을 하기 위함입니다.
